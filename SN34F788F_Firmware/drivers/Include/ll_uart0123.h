...
#ifndef _LL_UART0123_H_
#define _LL_UART0123_H_
 ...
 * @retval UART RX data
 */
__STATIC_INLINE uint32_t LL_UART0123_ReceiveData(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_TransmitData(SN_UART0_Type *uart, uint8_t data)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_SetDLL(SN_UART0_Type *uart, uint32_t dll)
{
 ...
 * @retval UART DLL
 */
__STATIC_INLINE uint32_t LL_UART0123_GetDLL(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_SetDLM(SN_UART0_Type *uart, uint32_t dlm)
{
 ...
 * @retval UART DLM
 */
__STATIC_INLINE uint32_t LL_UART0123_GetDLM(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_EnableIT_RDA(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_DisableIT_RDA(SN_UART0_Type *uart)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_IsEnabledIT_RDA(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_EnableIT_THRE(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_DisableIT_THRE(SN_UART0_Type *uart)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_IsEnabledIT_THRE(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_EnableIT_RLS(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_DisableIT_RLS(SN_UART0_Type *uart)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_IsEnabledIT_RLS(SN_UART0_Type *uart)
{
    return (LL_REG_READ(uart->IE) & UART_IE_RLSIE);
}

/**
 * @brief  This function is used to enable the UART MS interrupt
 * @note   The outage sources of RLS are CTS, DSR, RI, or DCD
 * @param  uart UART Instance
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_EnableIT_ModemStatus(SN_UART0_Type *uart)
{
    LL_REG_SBIT(uart->IE, UART_IE_MSIE);
}

/**
 * @brief  This function is used to disable the UART MS interrupt
 * @note   The outage sources of RLS are CTS, DSR, RI, or DCD
 * @param  uart UART Instance
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_DisableIT_ModemStatus(SN_UART0_Type *uart)
{
    LL_REG_CBIT(uart->IE, UART_IE_MSIE);
}

/**
 * @brief  This function is used to get the MS interrupt status
 * @note   The outage sources of RLS are CTS, DSR, RI, or DCD
 * @param  uart UART Instance
 * @retval MS interrupt status
 */
__STATIC_INLINE uint32_t LL_UART0123_IsEnabledIT_ModemStatus(SN_UART0_Type *uart)
{
    return (LL_REG_READ(uart->IE) & UART_IE_MSIE);
}

/**
 * @brief  This function is used to enable the UART RTS interrupt
 * @note   When RTSEN is set to 1,the loopback mode must not be set to 1 and FIFO
 * must be enabled
 * @param  uart UART Instance
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_Enable_RTS(SN_UART0_Type *uart)
{
    LL_REG_SBIT(uart->IE, UART_IE_RTSEN);
}

/**
 * @brief  This function is used to disable the UART RTS interrupt
 * @note   When RTSEN is set to 1,the loopback mode must not be set to 1 and FIFO
 * must be enabled
 * @param  uart UART Instance
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_Disable_RTS(SN_UART0_Type *uart)
{
    LL_REG_CBIT(uart->IE, UART_IE_RTSEN);
}

/**
 * @brief  This function is used to get the RTS interrupt status
 * @note   When RTSEN is set to 1,the loopback mode must not be set to 1 and FIFO
 * must be enabled
 * @param  uart UART Instance
 * @retval RTS interrupt status
 */
__STATIC_INLINE uint32_t LL_UART0123_IsEnabled_RTS(SN_UART0_Type *uart)
{
    return (LL_REG_READ(uart->IE) & UART_IE_RTSEN);
}

/**
 * @brief  This function is used to enable the UART CTS interrupt
 * @note   When CTSEN is set to 1,the loopback mode must not be set to 1 and FIFO
 * must be enabled
 * @param  uart UART Instance
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_Enable_CTS(SN_UART0_Type *uart)
{
    LL_REG_SBIT(uart->IE, UART_IE_CTSEN);
}

/**
 * @brief  This function is used to disable the UART CTS interrupt
 * @note   When CTSEN is set to 1,the loopback mode must not be set to 1 and FIFO
 * must be enabled
 * @param  uart UART Instance
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_Disable_CTS(SN_UART0_Type *uart)
{
    LL_REG_CBIT(uart->IE, UART_IE_CTSEN);
}

/**
 * @brief  This function is used to get the CTS interrupt status
 * @note   When CTSEN is set to 1,the loopback mode must not be set to 1 and FIFO
 * must be enabled
 * @param  uart UART Instance
 * @retval CTS interrupt status
 */
__STATIC_INLINE uint32_t LL_UART0123_IsEnabled_CTS(SN_UART0_Type *uart)
{
    return (LL_REG_READ(uart->IE) & UART_IE_CTSEN);
}
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_GetInterruptIdentification(SN_UART0_Type *uart)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_IsActiveFlag_TXFIFOFULL(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_Enable_FIFO(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_Disable_FIFO(SN_UART0_Type *uart)
{
 ...
 * @retval FIFO status
 */
__STATIC_INLINE uint32_t LL_UART0123_IsEnabled_FIFO(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_RXFIFOReset(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_TXFIFOReset(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_SetRXTriggerLevel(SN_UART0_Type *uart, uint32_t level)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_SetPrescaleValue(SN_UART0_Type *uart, uint32_t prescale)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_GetPrescaleValue(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_SetWordLength(SN_UART0_Type *uart, uint32_t length)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_GetWordLength(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_SetStopBits(SN_UART0_Type *uart, uint32_t stop_bit)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_GetStopBits(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_SetParity(SN_UART0_Type *uart, uint32_t parity)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_GetParity(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_Enable_BreakControl(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_Disable_BreakControl(SN_UART0_Type *uart)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_IsEnabled_BreakControl(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_Enable_DivisorLatchAccess(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_Disable_DivisorLatchAccess(SN_UART0_Type *uart)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_IsEnabled_DivisorLatchAccess(SN_UART0_Type *uart)
{
    return (LL_REG_READ(uart->LC) & UART_LC_DLAB);
}

/**
 * @brief  This function is used to set RTS
 * @note   Source from modem output (RTSn) pin. RTSn pin is always forced to inactive
 * state (high) in modem loopback mode
 * @param  uart UART Instance
 * @param  RTS RTS @ref uart_RTSn_pin_output
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_SetRTS(SN_UART0_Type *uart, uint32_t RTS)
{
    LL_REG_CBIT(uart->MC, UART_MC_RTSCTRL);
    LL_REG_SBIT(uart->MC, (RTS << UART_MC_RTSCTRL_Pos) & UART_MC_RTSCTRL);
}

/**
 * @brief  This function is used to get RTS status
 * @note   Source from modem output (RTSn) pin. RTSn pin is always forced to inactive
 * state (high) in modem loopback mode
 * @param  uart UART Instance
 * @retval RTS status @ref uart_RTSn_pin_output
 */
__STATIC_INLINE uint32_t LL_UART0123_GetRTS(SN_UART0_Type *uart)
{
    return ((LL_REG_READ(uart->MC) & UART_MC_RTSCTRL) >> UART_MC_RTSCTRL_Pos);
}
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_Enable_LoopbackMode(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_Disable_LoopbackMode(SN_UART0_Type *uart)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_IsEnabled_LoopbackMode(SN_UART0_Type *uart)
{
 ...
 * @retval Line Status
 */
__STATIC_INLINE uint32_t LL_UART0123_GetLineStatus(SN_UART0_Type *uart)
{
    return (REG_READ(uart->LS));
}
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_IsActiveFlag_RDR(SN_UART0_Type *uart)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_IsActiveFlag_OE(SN_UART0_Type *uart)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_IsActiveFlag_PE(SN_UART0_Type *uart)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_IsActiveFlag_FE(SN_UART0_Type *uart)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_IsActiveFlag_BI(SN_UART0_Type *uart)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_IsActiveFlag_THRE(SN_UART0_Type *uart)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_IsActiveFlag_TEMT(SN_UART0_Type *uart)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_IsActiveFlag_RXFE(SN_UART0_Type *uart)
{
    return (LL_REG_READ(uart->LS) & UART_LS_RXFE);
}

/**
 * @brief  This function is used to get Delta CTS status
 * @note   0: No change detected on modem input CTS pin
 *         1: State changes detected on modem input CTS pin
 * @param  uart UART Instance
 * @retval Delta CTS status
 */
__STATIC_INLINE uint32_t LL_UART0123_GetDeltaCTS(SN_UART0_Type *uart)
{
    return (LL_REG_READ(uart->MS) & UART_MS_DCTS);
}

/**
 * @brief  This function is used to get Complement of CTS pin input signal
 * @param  uart UART Instance
 * @retval Complement of CTS pin input signal
 */
__STATIC_INLINE uint32_t LL_UART0123_GetCTS(SN_UART0_Type *uart)
{
    return (LL_REG_READ(uart->MS) & UART_MS_CTS);
}
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_SetPadInformation(SN_UART0_Type *uart, uint32_t pad)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_GetPadInformation(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_SetUARTMode(SN_UART0_Type *uart, uint32_t mode)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_GetUARTMode(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_SetIRDASIRPulseInvert(SN_UART0_Type *uart, uint32_t pulse)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_GetIRDASIRPulseInvert(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_Enable_TX(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_Disable_TX(SN_UART0_Type *uart)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_IsEnabled_TX(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_Enable_RX(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_Disable_RX(SN_UART0_Type *uart)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_IsEnabled_RX(SN_UART0_Type *uart)
{
 ...
 * @retval none
 */
__STATIC_INLINE void LL_UART0123_SetIRDASIRPulseWidth(SN_UART0_Type *uart, uint32_t width)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_GetIRDASIRPulseWidth(SN_UART0_Type *uart)
{
 ...
 */
__STATIC_INLINE uint32_t LL_UART0123_GetRXFIFOCount(SN_UART0_Type *uart)
{
