...
## Bản SystemVerilog để mô phỏng

Bản mô phỏng độc lập, không gọi C/DPI và có test so sánh bit-for-bit với signer C
nằm trong [`verilog_sim/`](verilog_sim/README.md). Đây là behavioral SystemVerilog
dành cho QuestaSim, chưa phải RTL có thể tổng hợp lên FPGA.
